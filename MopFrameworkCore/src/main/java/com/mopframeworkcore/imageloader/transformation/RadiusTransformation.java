package com.mopframeworkcore.imageloader.transformation;
...
public class RadiusTransformation extends BitmapTransformation {
    ...
    private static final String ID = "RadiusTransformation" + VERSION;
    ...
    public boolean equals(Object o) {
        return o instanceof RadiusTransformation &&
                ((RadiusTransformation) o).radius == radius &&
                ((RadiusTransformation) o).diameter == diameter &&
                ((RadiusTransformation) o).margin == margin &&
                ((RadiusTransformation) o).cornerType == cornerType;
    }
