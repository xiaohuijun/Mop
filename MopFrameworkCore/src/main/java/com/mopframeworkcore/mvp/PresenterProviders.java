...
public class PresenterProviders {
    ...
    private static Application checkApplication(Activity activity) {
        ...
        if (application == null) {
            throw new IllegalStateException("Your com.test.example/fragment is not yet attached to Application. You can't request PresenterProviders before onCreate call.");
        }
        return application;
    }
