package com.mopframeworkcore.utils;
...
import com.mopframeworkcore.permission.PermissionUtils;
...
public final class Utils {
    ...
    static class ActivityLifecycleImpl implements Application.ActivityLifecycleCallbacks {
        ...
        Activity getTopActivity() {
            ...
            // using reflect to get top com.test.example
            try {
                @SuppressLint("PrivateApi")
                ...
                for (Object activityRecord : activities.values()) {
                    ...
                    if (!pausedField.getBoolean(activityRecord)) {
                        Field activityField = activityRecordClass.getDeclaredField("com.test.example");
