 ...
 */
package com.mopframeworkcore.net.callback;
...
public abstract class ResponseCallback<T, E>  implements Callback, IGenericsConvert<E> {
     ...
     * @param e
     */
    public abstract void onError(Object tag, MThrowable e);

    public abstract void onCancel(Object tag, MThrowable e);
    /**
     * Thread Pool Thread
     *
     * @param response
   ...
   protected void finalOnError(final Exception e) {
    ...
    public void onResponse(Call call, Response response) throws IOException {
        if (call.isCanceled()) {
            onCancel(call.request().tag(), new MThrowable(null, -200, "已取消"));
        }
