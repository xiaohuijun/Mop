 ...
 */
package com.mopframeworkcore.net.Exception;
...
public class NovateException {
    ...
    public static MThrowable handleException(Exception e) {
        ...
        if (!(e instanceof ServerException) && e instanceof HttpException) {
            ...
            ex = new MThrowable(e, httpException.code());
            switch (ex.getCode()) {
            ...
            ex = new MThrowable(e, resultException.code);
            ex.setMessage(resultException.message);
            return ex;
        } else if (e instanceof UnknownHostException) {
            LogWraper.e("Novate", e.getMessage());
            ex = new MThrowable(e, NOT_FOUND);
